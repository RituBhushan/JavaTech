...
//childDetails.setAge(12);
//System.out.println(2);
//System.out.println(childDetails.getAge());
//root.setChild_details(childDetails);

public class Report_API_Test {
	...
	public void addReport() {
		...
		reporter_details.setRequest_id("tr56");
		...
		//baseService1.executePOSTApi("/fmc/reports", generateTokenService.getTOKEN(), addReport);
		String s=generateTokenService.getTOKEN();
		
		Response res=baseService1.executePOSTApi("/fmc/reports", baseService1.getHeaderHavingAutorizationToken(s), addReport);
